...
For more information, we refer to the GCM package documentation and the [paper](https://github.com/JdHondt/gcm/blob/master/whitepaper.pdf) that introduces the GCM method.


## Requirements
The demo requires the following Python packages:
- gcm-syn (Generative Correlation Manifolds)
- pandas
- numpy
- matplotlib
- seaborn
